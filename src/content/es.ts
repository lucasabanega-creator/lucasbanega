export const es = {
  ...
  navigation: [
    ...
    { href: '/primer-objeto', label: 'Primer objeto' },
    { href: '/#materia', label: 'Materia y gesto' },
  ...
  idea: {
    ...
    text: 'Nos guía una forma de hacer: pensar cada proporción, atender a la materia y diseñar para acompañar la vida cotidiana.',
  },
  material: {
    title: 'La materia, de cerca.',
    text: 'El tacto, la flexibilidad y la respuesta a la luz orientan nuestras decisiones. El objeto se definirá a partir del desarrollo técnico y de muestras reales.',
  },
  first: {
